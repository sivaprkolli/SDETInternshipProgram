...
public class ReadDataCommonMethod {

    public String readTestData(String fileName, String sheetName, String rowCellvalue, String colCellValue) throws IOException {
        ...
        for(Row row: xssfSheet){
            ...
            if(cell != null
                    ...
                    && cell.getStringCellValue().equals(rowCellvalue)){
        ...
        for(Cell cell: headerRow){
            ...
            if(cell != null
                    && cell.getCellType() == CellType.STRING
                    && cell.getStringCellValue().equals(colCellValue)){
...
//        return String.valueOf(valueX);
    ...
    public void readDataFromExcel(){
        try {
            readTestData("CCInfo.xlsx", "ProdData", "User Name", "ProdCompany");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
