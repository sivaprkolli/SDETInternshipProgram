...
public class GridTest {
    ...
    @Parameters({"browserName","hostAddress"})
    @BeforeTest
    public void setup(String browserName, String hostAddress) throws MalformedURLException {
        WebDriver driver = setupBrowser(browserName, hostAddress);
        threadLocalDriver.set(driver);
        System.out.println("Before Test Thread ID: "+Thread.currentThread().getId());
    }

    public static WebDriver setupBrowser(String browserName, String hostAddress) throws MalformedURLException {
        ...
        switch (browserName){
            case "firefox":
                ...
                driver = new RemoteWebDriver(new URL(hostAddress), firefoxOptions);
                break;
            ...
            case "chrome":
                ...
                driver = new RemoteWebDriver(new URL(hostAddress), chromeOptions);
                break;
